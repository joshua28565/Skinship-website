    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">SKINSHIP - Administrator Panel</a>
            </div>
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Welcome to SKINSHIP! Dive into a world where radiant skin meets exceptional care. At our online store, we're passionate about delivering products that not only enhance your natural beauty but also prioritize the health and vitality of your skin. Whether you're on a journey to discover your perfect regimen or seeking trusted staples, we're here to guide you towards glowing confidence.
                    </div>
					<br />
			
			<div class="alert alert-default" style="background-color:#033c73;">
                       <p style="color:white;text-align:center;">
                       &copy 2024 SKINSHIP | All Rights Reserved | Design by : DEVKNIGHT Team
